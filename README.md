...
| `ali-finalize-pr`                | Lands a finished pull request: refuses to merge while a review thread is unresolved or a check failed, waits out the pending checks, then merges, switches the checkout to the base branch and pulls.                          |
